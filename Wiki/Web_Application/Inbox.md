...
3. **Delete**: Click **Delete** to move emails to trash
4. **Search**: Use the search box to find emails by sender or subject
5. **Labels**: Apply labels to organize your emails

<img width="1920" height="1080" alt="example_asset_06" src="https://github.com/user-attachments/assets/0cafee0c-7283-4e14-bf22-c08464721ff2" />
...
#### Email Actions
- **Spam** Report an email as spam
- **Delete** to move to trash
- **Star** to star an email
...
- **Quick label assignment** from the email view page
...
<img width="1920" height="1080" alt="example_asset_07" src="https://github.com/user-attachments/assets/0589b99a-0b15-4747-8cdc-71b5066b3196" />
